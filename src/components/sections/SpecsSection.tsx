  ...
  return (
    <section id="specs" className="px-4 py-20 md:px-8 md:py-28 lg:px-0 lg:py-36">
      <div className="mx-auto max-w-7xl">
        ...
        <Reveal variant="fade" className="mt-10 rounded-3xl border border-border bg-card p-6 md:p-8">
        ...
        <RevealGroup className="mt-8 grid gap-4 lg:grid-cols-2 lg:gap-6">
          {products.map((product) => (
            <Reveal key={product.id} variant="stagger-item">
