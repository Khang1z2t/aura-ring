  ...
  return (
    <section className="relative overflow-hidden px-4 py-20 md:px-8 md:py-28 lg:px-0 lg:py-0">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center gap-12 lg:flex-row lg:items-center lg:gap-16">
        <Reveal className="max-w-xl lg:mx-auto lg:w-full lg:max-w-[34rem]">
          ...
          <h1 className="mt-6 font-display text-5xl font-semibold tracking-[-0.04em] text-balance md:text-6xl lg:text-7xl">
          ...
          <div className="mt-10 grid gap-4 border-t border-border/70 pt-6 sm:grid-cols-3 sm:gap-6">
            {heroStats.map((stat) => (
              <div key={stat.label} className="space-y-1 sm:pr-4">
        ...
        <Reveal delay={0.1} className="relative flex flex-1 items-center justify-center lg:w-1/2">
